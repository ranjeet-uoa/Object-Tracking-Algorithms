...
parfor t = 1 : num_mc
    ...
    est_ckf{t} =   run_filter_ckf(model,meas{t});
    est_pf_1k{t} =   run_filter_pf(model,meas{t},'num_particles',1000);
    ...
    est_pf_10k{t} =   run_filter_pf(model,meas{t},'num_particles',10000);
end
